...
public class Activity_Map extends AppCompatActivity
    ...
    private static final String TAG = Activity_Map.class.getSimpleName();
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mBound = true;
            //Toast.makeText(Activity_Map.this, "운동 시작 버튼을 눌러주세요", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            mService = null;
            mBound = false;
            Toast.makeText(Activity_Map.this, "디스바인딩", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_activity_walk);
        previous_marker = new ArrayList<Marker>();
        mLayout = findViewById(R.id.walk_main);
...
//        mRemoveLocationUpdatesButton.setEnabled(false);
        ...
        if (checkPermission()) {
            ...
            Log.e("mMap", "mMapmMapmMapmMapmMapmMapmMap11111: ");
            if (mMap != null)
                mMap.setMyLocationEnabled(true);
        }
...
//                .registerOnSharedPreferenceChangeListener((SharedPreferences.OnSharedPreferenceChangeListener) this);
        ...
        mRemoveLocationUpdatesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //내장 디비 연결을 합니다.
                walkResult = getSharedPreferences("walkResult", MODE_PRIVATE);    // activityValue이름의 파일 생성
                SharedPreferences.Editor editor = walkResult.edit(); //sharedPreferences를 제어할 editor를 선언
                ...
                //값이 확인용 출력
                String speedValue = walkResult.getString("speed", null);
                String distanceValue = walkResult.getString("distance", null);
                String timeValue = walkResult.getString("time", null);
                String kcalValue = walkResult.getString("kcal", null);
                ...
                //파베 저장용 데이터 지정
                activity_dto.walk_distance = distanceValue;
                activity_dto.walk_speed = speedValue;
                activity_dto.walk_time = timeValue;
                activity_dto.walk_kcal = kcalValue;
                activity_dto.walk_Week = String.valueOf(calendar_week);

                //파베에 데이터 저장
                //데이터를 쌓아주고 싶으면 child뒤에 push를 사용한다.
                mPostReference.child("users").child(strEmail).child("activity").child("walk_activity").push().setValue(activity_dto);

                Toast.makeText(Activity_Map.this, "DB에저장되었습니다.", Toast.LENGTH_SHORT).show();
                //값 초기화 부분
