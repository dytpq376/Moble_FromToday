...
public class Activity_Map_Run extends AppCompatActivity
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mBound = true;
            //Toast.makeText(Activity_Map_Run.this, "운동 시작 버튼을 눌러주세요", Toast.LENGTH_SHORT).show();
        ...
        public void onServiceDisconnected(ComponentName name) {
            mService = null;
            mBound = false;
            Toast.makeText(Activity_Map_Run.this, "디스바인딩", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout = findViewById(R.id.run_main);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions(Activity_Map_Run.this, REQUIRED_PERMISSIONS,
...
//                .registerOnSharedPreferenceChangeListener((SharedPreferences.OnSharedPreferenceChangeListener) this);
        ...
        mRemoveLocationUpdatesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Activity_Map_Run.this, "DB에저장되었습니다.", Toast.LENGTH_SHORT).show();
                //값 초기화 부분
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(Activity_Map_Run.this,
...
//                setButtonsState(false);
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Activity_Map_Run.this);
    ...
    public void showPlaceInformation(LatLng location) {
        ...
        new NRPlaces.Builder()
                .listener(Activity_Map_Run.this)
