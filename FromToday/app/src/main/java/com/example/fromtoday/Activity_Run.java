 ...
 */
public class Activity_Run extends AppCompatActivity implements
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mBound = true;
            Toast.makeText(Activity_Run.this, "예스 로케이션 서비스 바인딩", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            mService = null;
            mBound = false;
            Toast.makeText(Activity_Run.this, "디스바인딩", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frag_activity_run);
    ...
    protected void onStart() {
        ...
        mRemoveLocationUpdatesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //레퍼런스에 값 저장해야 하는 부분
                Log.e(TAG, "mRemoveLocationUpdatesButton: ");
                ...
                Log.e(TAG, "commit  commit  commit: ");
                ...
                Toast.makeText(Activity_Run.this, "DB에저장되었습니다.", Toast.LENGTH_SHORT).show();
                //값 초기화 부분
                ...
                //콜백 멤버 변수는 locationservice에서 unbinde시 초기화 하도록 세팅하였습니다.

                mService.removeLocationUpdates();//서비스 언바인드
            }
        });
    ...
    private SpeedCallback speedCallback = new SpeedCallback() {
        ...
        public void onLocationCallback(double speed, double distance, int time, double sumkcal) {
            ...
            //합산된 칼로리는 오늘 몇번을 운동 했던지 상관없이 운동으로만 합산된 칼로리로
            //오늘 운동한 총 칼로리의 지표가 된다.
            //sumkcal += kcal;
            ...
            Log.e(TAG, "db_speed: 디비 저장 스피드는" + db_speed);
            Log.e(TAG, "db_distance: 디비 저장 거리는" + db_distance);
            Log.e(TAG, "db_time: 디비 저장 시간는" + db_time);
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(Activity_Run.this,
