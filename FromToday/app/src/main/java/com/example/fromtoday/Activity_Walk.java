...
public class Activity_Walk extends AppCompatActivity implements
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mBound = true;
            Toast.makeText(Activity_Walk.this, "예스 로케이션 서비스 바인딩", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onServiceDisconnected(ComponentName name) {
            mService = null;
            mBound = false;
            Toast.makeText(Activity_Walk.this, "디스바인딩", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    protected void onStart() {
        ...
        mRemoveLocationUpdatesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Activity_Walk.this, "DB에저장되었습니다.", Toast.LENGTH_SHORT).show();
                //값 초기화 부분
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(Activity_Walk.this,
